...
describe('FySelector', () => {
  it("renders 'All' button plus one per FY", () => {
    render(
      <FySelector availableFys={['2021-22', '2022-23']} selectedFy="all" onSelect={() => {}} />,
    )
  ...
  it("renders only 'All' when no FYs available", () => {
    render(<FySelector availableFys={[]} selectedFy="all" onSelect={() => {}} />)
  ...
  it('calls onSelect with FY value when clicked', async () => {
    ...
    render(
      <FySelector availableFys={['2021-22', '2022-23']} selectedFy="all" onSelect={onSelect} />,
    )
  ...
  it("calls onSelect with 'all' when All button clicked", async () => {
    const onSelect = vi.fn()
    render(<FySelector availableFys={['2021-22']} selectedFy="2021-22" onSelect={onSelect} />)
