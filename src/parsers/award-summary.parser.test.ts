...
const ROW_9375 = '15-Mar-2026,15-Feb-2018,9375,Share Units (RSU),02.15.2018 RSU Grant (New Hire),New Hire,$52.6476,USD,475,475,"$91,148.86",USD,0,$0.00,USD';
const ROW_83105 = '15-Mar-2026,20-Sep-2024,83105,Share Units (RSU),20 SEP 2024 RSU Grant (APEX),Ongoing,$152.6986,USD,"1,520",570,"$113,878.40",USD,950,"$71,449.50",USD';
...
describe("parseAwardSummary", () => {
  ...
  it("returns error on malformed date", () => {
    const badRow = 'bad-date,bad-date,9375,Share Units (RSU),Grant,New Hire,$52.6476,USD,475,475,"$91,148.86",USD,0,$0.00,USD';
