...
const ROW_1 = '01-Jan-2020,15-Mar-2026,15-Feb-2018,9375,Share Units (RSU),02.15.2018 RSU Grant (New Hire),New Hire,18-Feb-2020,30,0,30,"$4,616.40",USD,$153.88,USD,,,,,,$0.00,USD,RB6538C8B1';
const ROW_2 = '01-Jan-2020,15-Mar-2026,15-Jan-2019,14333,Share Units (RSU),15 JAN 2019 RSU Grant,Refresh,18-Feb-2020,67,0,67,"$10,309.96",USD,$153.88,USD,,,,,,$0.00,USD,RB65388044';
...
describe("parseRsuReleases", () => {
  it("parses golden values for first release", () => {
    ...
    expect(r.valueUsd).toBe(4616.40);
  ...
  it("returns error on malformed release date", () => {
    const badRow = '01-Jan-2020,15-Mar-2026,15-Feb-2018,9375,Share Units (RSU),Grant,New Hire,bad-date,30,0,30,"$4,616.40",USD,$153.88,USD,,,,,,$0.00,USD,RB6538C8B1';
