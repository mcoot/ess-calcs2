...
const ROW_1 = '01-Jan-2020,15-Mar-2026,WRC6476B1C8-1EE,RB54549F21,9375,02.15.2018 RSU Grant (New Hire),1,Long Shares,29-Jan-2020,18-Feb-2019,NO,$104.90,USD,"$3,147.00",USD,30,"$4,478.10",USD,$149.2700,USD,$39.33,USD,$0.39,USD';
const ROW_2 = '01-Jan-2020,15-Mar-2026,WRC692F7C95-1EE,RB54549F21,9375,02.15.2018 RSU Grant (New Hire),1,Long Shares,05-May-2020,18-Feb-2019,NO,$104.90,USD,"$9,231.20",USD,88,"$14,445.20",USD,$164.1500,USD,$11.48,USD,$0.42,USD';
const TOTAL_ROW = ',,,,,,,,,,,,,,,,,,,,,,,,';
...
describe("parseSales", () => {
  it("parses golden values for first sale lot", () => {
    ...
    expect(lot.costBasisPerShare).toBe(104.90);
    expect(lot.costBasis).toBe(3147.00);
    expect(lot.sharesSold).toBe(30);
    expect(lot.saleProceeds).toBe(4478.10);
  ...
  it("returns error on malformed sale date", () => {
    const badRow = '01-Jan-2020,15-Mar-2026,WRC6476B1C8-1EE,RB54549F21,9375,Grant,1,Long Shares,bad-date,18-Feb-2019,NO,$104.90,USD,"$3,147.00",USD,30,"$4,478.10",USD,$149.27,USD,$39.33,USD,$0.39,USD';
