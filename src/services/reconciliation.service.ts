...
export interface ReconciliationService {
  validate(awards: Award[], releases: RsuRelease[], saleLots: SaleLot[]): ReconciliationWarning[]
}

// ── Factory ────────────────────────────────────────────────────────

export function createReconciliationService(): ReconciliationService {
  function checkShareCounts(awards: Award[], releases: RsuRelease[]): ReconciliationWarning[] {
  ...
  function checkOrphanRefs(releases: RsuRelease[], saleLots: SaleLot[]): ReconciliationWarning[] {
  ...
  function checkOversold(releases: RsuRelease[], saleLots: SaleLot[]): ReconciliationWarning[] {
    const warnings: ReconciliationWarning[] = []
